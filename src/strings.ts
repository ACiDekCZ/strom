...
const stringsEN = {
    ...
    menu: {
        ...
        splitFamiliesHint: 'Cut one connected tree into a tree per family, seen from a chosen person.',
...
const stringsCZ: StringsType = {
    ...
    menu: {
        ...
        splitFamiliesHint: 'Rozřeže jeden spojený strom na strom pro každou rodinu z pohledu zvolené osoby.',
