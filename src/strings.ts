...
const stringsEN = {
    ...
    poster: {
        ...
        viewTimelineBlocked: 'Timeline poster is coming soon — switch to a tree or fan view to print.',
        svg: 'SVG (vector)',
...
const stringsCZ: StringsType = {
    ...
    poster: {
        ...
        viewTimelineBlocked: 'Plakát z časové osy teprve chystáme — pro tisk přepni na strom nebo vějíř.',
        svg: 'SVG (vektor)',
