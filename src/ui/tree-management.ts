            ...
            html += `
                <div class="tree-manager-item ${isActive ? 'active' : ''} ${tree.isHidden ? 'hidden-tree' : ''}">
                    ...
                    <div class="tree-manager-item-actions">
                        ...
                        <button class="edit-only" onclick="window.Strom.UI.showSnapshotsDialog('${tree.id}')" title="${strings.snapshots.menu}"><span class="btn-icon">🕑</span><span class="btn-text">${strings.snapshots.menu}</span></button>
